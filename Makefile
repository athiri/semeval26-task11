...
help:
	@echo "SemEval 2026 Task 11 - Available Commands"
	@echo ""
	@echo "Setup:"
	...
	@echo ""
	@echo "Training:"
	@echo "  make train          - Train baseline model (Subtask 1)"
...
data:
	...
	python3 src/generate_data.py --subtask 2
	python3 src/generate_data.py --subtask 3
	python3 src/generate_data.py --subtask 4
	@echo "✅ Data generated in data/ directory"

# Train baseline model
train:
	@echo "Training baseline model (Subtask 1)..."
	python3 src/pipeline.py train --subtask 1

# Train all models
train-all:
	@echo "Training all models..."
	python3 src/pipeline.py train --subtask 1 --model-type logistic_regression
	python3 src/pipeline.py train --subtask 1 --model-type random_forest
	python3 src/pipeline.py train --subtask 1 --model-type gradient_boosting
...
validate:
	...
	@echo "Note: Implement validation command in pipeline.py"
...
# Show project info
info:
	@echo "Project: SemEval 2026 Task 11"
	@echo "Training data: $(shell ls -1 data/train_*.json 2>/dev/null | wc -l) files"
